...
CREATE INDEX IDX_ALC_STATS_IPRAN_HOUR_F ON ALC_STATS_IPRAN_HOUR(TO_CHAR(FECHA,'DD.MM.YYYY')) LOCAL;
CREATE INDEX IDX_ALC_STATS_IPRAN_HOUR_FH ON ALC_STATS_IPRAN_HOUR(TO_CHAR(FECHA,'DD.MM.YYYY HH24')) LOCAL;
