...
--
CREATE INDEX IDX_ALC_STATS_CPUMEM_DAY ON ALC_STATS_CPUMEM_DAY (FECHA,MONITORED_OBJECT_SITE_ID,MONITORED_OBJECT_SITE_NAME) 
LOCAL TABLESPACE TBS_DAY;

CREATE INDEX IDX_ALC_STATS_CPUMEM_DAY_F ON ALC_STATS_CPUMEM_DAY (TO_CHAR(FECHA,'DD.MM.YYYY')) 
LOCAL TABLESPACE TBS_DAY;

CREATE INDEX IDX_ALC_STATS_CPUMEM_DAY_FH ON ALC_STATS_CPUMEM_DAY (TO_CHAR(FECHA,'DD.MM.YYYY HH24')) 
LOCAL TABLESPACE TBS_DAY;